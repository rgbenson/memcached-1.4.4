...
#define GETLEN_SUFFIX_SIZE 40 /* ~= flags + value size + \r\n + 2 spaces. */

/** Initial size of list of items being returned by "get". */
#define ITEM_LIST_INITIAL 200

/** Initial size of list of CAS suffixes appended to "gets" lines. */
#define CAS_SUFFIX_LIST_INITIAL 20
/** Initial size of list of getlen suffixes used in "get_len" lines. */
#define GETLEN_SUFFIX_LIST_INITIAL 20
...
/**
 * Response suffix types that could be used if the cas or get_len
 * features are in use.
 */
typedef enum suffix_cache_type {
  cas_suffix_type,
  getlen_suffix_type,
  max_suffix_type
} suffix_cache_type_t;
...
typedef struct {
    ...
    cache_t *suffix_caches[max_suffix_type]; /* cas and getlen suffix caches */
} LIBEVENT_THREAD;
...
struct conn {
    ...
    suffixes_t suffixes[max_suffix_type];
